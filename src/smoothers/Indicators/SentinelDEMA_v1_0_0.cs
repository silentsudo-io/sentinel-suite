...
{
    public class SentinelDEMA_v1_0_0 : Indicator
    {
        ...
        private Series<double> _e2;   // EMA of the EMA

        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                Description              = "Sentinel smoother library — Double Exponential Moving Average (clean-room). DEMA = 2·EMA − EMA(EMA) + a Sentinel glass card. A building block, not a Council voter (no State seam).";
                Name                     = "Sentinel DEMA v1.0.0";
                ...
                AddPlot(new Stroke(Brushes.SkyBlue, 2), PlotStyle.Line, "DEMA");
            }
        ...
        {
            // Clean-room DEMA: cascade two internal EMAs (each seeded to its first input), then 2·e1 − e2.
            _e1[0] = CurrentBar == 0 ? Input[0] : _e1[1] + _alpha * (Input[0] - _e1[1]);
            _e2[0] = CurrentBar == 0 ? _e1[0]   : _e2[1] + _alpha * (_e1[0]  - _e2[1]);
            Value[0] = 2.0 * _e1[0] - _e2[0];
        ...
        private void RenderCard()
        {
            ...
            _sp.Text("DEMA", r.Left + 16f, r.Top, r.Width - 70f, 16f, SentinelSkin.CInk, 11f, true);
        ...
        [Browsable(false)]
        [XmlIgnore]
        public Series<double> DEMA => Values[0];

        #region Properties
        [Range(1, int.MaxValue)]
        [NinjaScriptProperty]
        [Display(Name = "Period", Description = "EMA span used for both cascade stages.", Order = 1, GroupName = "Parameters")]
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private Sentinel.Smoothers.SentinelDEMA_v1_0_0[] cacheSentinelDEMA_v1_0_0;
		public Sentinel.Smoothers.SentinelDEMA_v1_0_0 SentinelDEMA_v1_0_0(int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return SentinelDEMA_v1_0_0(Input, period, showCard, cardCorner, showIndicatorLabel);
		}

		public Sentinel.Smoothers.SentinelDEMA_v1_0_0 SentinelDEMA_v1_0_0(ISeries<double> input, int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			if (cacheSentinelDEMA_v1_0_0 != null)
				for (int idx = 0; idx < cacheSentinelDEMA_v1_0_0.Length; idx++)
					if (cacheSentinelDEMA_v1_0_0[idx] != null && cacheSentinelDEMA_v1_0_0[idx].Period == period && cacheSentinelDEMA_v1_0_0[idx].ShowCard == showCard && cacheSentinelDEMA_v1_0_0[idx].CardCorner == cardCorner && cacheSentinelDEMA_v1_0_0[idx].ShowIndicatorLabel == showIndicatorLabel && cacheSentinelDEMA_v1_0_0[idx].EqualsInput(input))
						return cacheSentinelDEMA_v1_0_0[idx];
			return CacheIndicator<Sentinel.Smoothers.SentinelDEMA_v1_0_0>(new Sentinel.Smoothers.SentinelDEMA_v1_0_0(){ Period = period, ShowCard = showCard, CardCorner = cardCorner, ShowIndicatorLabel = showIndicatorLabel }, input, ref cacheSentinelDEMA_v1_0_0);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.Sentinel.Smoothers.SentinelDEMA_v1_0_0 SentinelDEMA_v1_0_0(int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return indicator.SentinelDEMA_v1_0_0(Input, period, showCard, cardCorner, showIndicatorLabel);
		}

		public Indicators.Sentinel.Smoothers.SentinelDEMA_v1_0_0 SentinelDEMA_v1_0_0(ISeries<double> input , int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return indicator.SentinelDEMA_v1_0_0(input, period, showCard, cardCorner, showIndicatorLabel);
		}
	}
