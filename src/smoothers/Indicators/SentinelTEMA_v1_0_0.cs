...
{
    public class SentinelTEMA_v1_0_0 : Indicator
    {
        ...
        private Series<double> _e1;   // EMA of input
        private Series<double> _e2;   // EMA of e1
        private Series<double> _e3;   // EMA of e2

        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                Description              = "Sentinel smoother library — Triple Exponential Moving Average (clean-room). TEMA = 3·e1 − 3·e2 + e3 + a Sentinel glass card. A building block, not a Council voter (no State seam).";
                Name                     = "Sentinel TEMA v1.0.0";
                ...
                AddPlot(new Stroke(Brushes.SkyBlue, 2), PlotStyle.Line, "TEMA");
            }
        ...
        {
            // Clean-room TEMA: cascade three internal EMAs (each seeded to its first input), then 3·e1 − 3·e2 + e3.
            _e1[0] = CurrentBar == 0 ? Input[0] : _e1[1] + _alpha * (Input[0] - _e1[1]);
            _e2[0] = CurrentBar == 0 ? _e1[0]   : _e2[1] + _alpha * (_e1[0]  - _e2[1]);
            _e3[0] = CurrentBar == 0 ? _e2[0]   : _e3[1] + _alpha * (_e2[0]  - _e3[1]);
            Value[0] = 3.0 * _e1[0] - 3.0 * _e2[0] + _e3[0];
        ...
        private void RenderCard()
        {
            ...
            _sp.Text("TEMA", r.Left + 16f, r.Top, r.Width - 70f, 16f, SentinelSkin.CInk, 11f, true);
        ...
        [Browsable(false)]
        [XmlIgnore]
        public Series<double> TEMA => Values[0];

        #region Properties
        [Range(1, int.MaxValue)]
        [NinjaScriptProperty]
        [Display(Name = "Period", Description = "EMA span used for all three cascade stages.", Order = 1, GroupName = "Parameters")]
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private Sentinel.Smoothers.SentinelTEMA_v1_0_0[] cacheSentinelTEMA_v1_0_0;
		public Sentinel.Smoothers.SentinelTEMA_v1_0_0 SentinelTEMA_v1_0_0(int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return SentinelTEMA_v1_0_0(Input, period, showCard, cardCorner, showIndicatorLabel);
		}

		public Sentinel.Smoothers.SentinelTEMA_v1_0_0 SentinelTEMA_v1_0_0(ISeries<double> input, int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			if (cacheSentinelTEMA_v1_0_0 != null)
				for (int idx = 0; idx < cacheSentinelTEMA_v1_0_0.Length; idx++)
					if (cacheSentinelTEMA_v1_0_0[idx] != null && cacheSentinelTEMA_v1_0_0[idx].Period == period && cacheSentinelTEMA_v1_0_0[idx].ShowCard == showCard && cacheSentinelTEMA_v1_0_0[idx].CardCorner == cardCorner && cacheSentinelTEMA_v1_0_0[idx].ShowIndicatorLabel == showIndicatorLabel && cacheSentinelTEMA_v1_0_0[idx].EqualsInput(input))
						return cacheSentinelTEMA_v1_0_0[idx];
			return CacheIndicator<Sentinel.Smoothers.SentinelTEMA_v1_0_0>(new Sentinel.Smoothers.SentinelTEMA_v1_0_0(){ Period = period, ShowCard = showCard, CardCorner = cardCorner, ShowIndicatorLabel = showIndicatorLabel }, input, ref cacheSentinelTEMA_v1_0_0);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.Sentinel.Smoothers.SentinelTEMA_v1_0_0 SentinelTEMA_v1_0_0(int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return indicator.SentinelTEMA_v1_0_0(Input, period, showCard, cardCorner, showIndicatorLabel);
		}

		public Indicators.Sentinel.Smoothers.SentinelTEMA_v1_0_0 SentinelTEMA_v1_0_0(ISeries<double> input , int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return indicator.SentinelTEMA_v1_0_0(input, period, showCard, cardCorner, showIndicatorLabel);
		}
	}
