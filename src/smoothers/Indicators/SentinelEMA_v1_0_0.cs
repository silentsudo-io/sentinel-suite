...
{
    public class SentinelEMA_v1_0_0 : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description              = "Sentinel smoother library — Exponential Moving Average (clean-room). Draws an EMA (alpha = 2/(Period+1)) + a Sentinel glass card. A building block, not a Council voter (no State seam).";
                Name                     = "Sentinel EMA v1.0.0";
                ...
                AddPlot(new Stroke(Brushes.SkyBlue, 2), PlotStyle.Line, "EMA");
            }
        ...
        {
            // Clean-room EMA: seed to the first input, then a recursive alpha blend of input vs prior EMA.
            Value[0] = CurrentBar == 0 ? Input[0] : Value[1] + _alpha * (Input[0] - Value[1]);
        ...
        private void RenderCard()
        {
            ...
            _sp.Text("EMA", r.Left + 16f, r.Top, r.Width - 70f, 16f, SentinelSkin.CInk, 11f, true);
        ...
        [Browsable(false)]
        [XmlIgnore]
        public Series<double> EMA => Values[0];

        #region Properties
        [Range(1, int.MaxValue)]
        [NinjaScriptProperty]
        [Display(Name = "Period", Description = "Number of inputs in the EMA span.", Order = 1, GroupName = "Parameters")]
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private Sentinel.Smoothers.SentinelEMA_v1_0_0[] cacheSentinelEMA_v1_0_0;
		public Sentinel.Smoothers.SentinelEMA_v1_0_0 SentinelEMA_v1_0_0(int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return SentinelEMA_v1_0_0(Input, period, showCard, cardCorner, showIndicatorLabel);
		}

		public Sentinel.Smoothers.SentinelEMA_v1_0_0 SentinelEMA_v1_0_0(ISeries<double> input, int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			if (cacheSentinelEMA_v1_0_0 != null)
				for (int idx = 0; idx < cacheSentinelEMA_v1_0_0.Length; idx++)
					if (cacheSentinelEMA_v1_0_0[idx] != null && cacheSentinelEMA_v1_0_0[idx].Period == period && cacheSentinelEMA_v1_0_0[idx].ShowCard == showCard && cacheSentinelEMA_v1_0_0[idx].CardCorner == cardCorner && cacheSentinelEMA_v1_0_0[idx].ShowIndicatorLabel == showIndicatorLabel && cacheSentinelEMA_v1_0_0[idx].EqualsInput(input))
						return cacheSentinelEMA_v1_0_0[idx];
			return CacheIndicator<Sentinel.Smoothers.SentinelEMA_v1_0_0>(new Sentinel.Smoothers.SentinelEMA_v1_0_0(){ Period = period, ShowCard = showCard, CardCorner = cardCorner, ShowIndicatorLabel = showIndicatorLabel }, input, ref cacheSentinelEMA_v1_0_0);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.Sentinel.Smoothers.SentinelEMA_v1_0_0 SentinelEMA_v1_0_0(int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return indicator.SentinelEMA_v1_0_0(Input, period, showCard, cardCorner, showIndicatorLabel);
		}

		public Indicators.Sentinel.Smoothers.SentinelEMA_v1_0_0 SentinelEMA_v1_0_0(ISeries<double> input , int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return indicator.SentinelEMA_v1_0_0(input, period, showCard, cardCorner, showIndicatorLabel);
		}
	}
