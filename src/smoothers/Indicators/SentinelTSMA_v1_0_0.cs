...
{
    public class SentinelTSMA_v1_0_0 : Indicator
    {
        ...
        private Series<double> _s1;   // SMA(price)
        private Series<double> _s2;   // SMA(s1)

        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                Description              = "Sentinel smoother library — Triple Simple Moving Average (clean-room, 3·SMA − 3·SMA² + SMA³). Draws a lag-reduced smoothed line + a Sentinel glass card. A building block, not a Council voter (no State seam).";
                Name                     = "Sentinel TSMA v1.0.0";
        ...
        // Clean-room SMA of the current bar of a series, over the available window.
        private double Sma(ISeries<double> src, int period)
        {
        ...
        {
            // Clean-room Triple SMA: cascade three simple means, combine TEMA-style.
            _s1[0] = Sma(Input, Period);
            _s2[0] = Sma(_s1,   Period);
            double s3 = Sma(_s2, Period);
            Value[0] = 3.0 * _s1[0] - 3.0 * _s2[0] + s3;
        ...
        private void RenderCard()
        {
            ...
            _sp.Text("TSMA", r.Left + 16f, r.Top, r.Width - 70f, 16f, SentinelSkin.CInk, 11f, true);
        ...
        [Browsable(false)]
        [XmlIgnore]
        public Series<double> TSMA => Values[0];

        #region Properties
        [Range(1, int.MaxValue)]
        [NinjaScriptProperty]
        [Display(Name = "Period", Description = "Length of each cascaded SMA stage.", Order = 1, GroupName = "Parameters")]
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private Sentinel.Smoothers.SentinelTSMA_v1_0_0[] cacheSentinelTSMA_v1_0_0;
		public Sentinel.Smoothers.SentinelTSMA_v1_0_0 SentinelTSMA_v1_0_0(int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return SentinelTSMA_v1_0_0(Input, period, showCard, cardCorner, showIndicatorLabel);
		}

		public Sentinel.Smoothers.SentinelTSMA_v1_0_0 SentinelTSMA_v1_0_0(ISeries<double> input, int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			if (cacheSentinelTSMA_v1_0_0 != null)
				for (int idx = 0; idx < cacheSentinelTSMA_v1_0_0.Length; idx++)
					if (cacheSentinelTSMA_v1_0_0[idx] != null && cacheSentinelTSMA_v1_0_0[idx].Period == period && cacheSentinelTSMA_v1_0_0[idx].ShowCard == showCard && cacheSentinelTSMA_v1_0_0[idx].CardCorner == cardCorner && cacheSentinelTSMA_v1_0_0[idx].ShowIndicatorLabel == showIndicatorLabel && cacheSentinelTSMA_v1_0_0[idx].EqualsInput(input))
						return cacheSentinelTSMA_v1_0_0[idx];
			return CacheIndicator<Sentinel.Smoothers.SentinelTSMA_v1_0_0>(new Sentinel.Smoothers.SentinelTSMA_v1_0_0(){ Period = period, ShowCard = showCard, CardCorner = cardCorner, ShowIndicatorLabel = showIndicatorLabel }, input, ref cacheSentinelTSMA_v1_0_0);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.Sentinel.Smoothers.SentinelTSMA_v1_0_0 SentinelTSMA_v1_0_0(int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return indicator.SentinelTSMA_v1_0_0(Input, period, showCard, cardCorner, showIndicatorLabel);
		}

		public Indicators.Sentinel.Smoothers.SentinelTSMA_v1_0_0 SentinelTSMA_v1_0_0(ISeries<double> input , int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return indicator.SentinelTSMA_v1_0_0(input, period, showCard, cardCorner, showIndicatorLabel);
		}
	}
