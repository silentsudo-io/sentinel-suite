...
{
    public class SentinelSMA_v1_0_0 : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description              = "Sentinel smoother library — Simple Moving Average (clean-room). Draws the arithmetic mean of the last N inputs + a Sentinel glass card. A building block, not a Council voter (no State seam).";
                Name                     = "Sentinel SMA v1.0.0";
                ...
                AddPlot(new Stroke(Brushes.SkyBlue, 2), PlotStyle.Line, "SMA");
            }
        ...
        {
            // Clean-room SMA: arithmetic mean of the last min(CurrentBar+1, Period) inputs.
        ...
        private void RenderCard()
        {
            ...
            _sp.Text("SMA", r.Left + 16f, r.Top, r.Width - 70f, 16f, SentinelSkin.CInk, 11f, true);
        ...
        [Browsable(false)]
        [XmlIgnore]
        public Series<double> SMA => Values[0];

        #region Properties
        [Range(1, int.MaxValue)]
        [NinjaScriptProperty]
        [Display(Name = "Period", Description = "Number of inputs averaged.", Order = 1, GroupName = "Parameters")]
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private Sentinel.Smoothers.SentinelSMA_v1_0_0[] cacheSentinelSMA_v1_0_0;
		public Sentinel.Smoothers.SentinelSMA_v1_0_0 SentinelSMA_v1_0_0(int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return SentinelSMA_v1_0_0(Input, period, showCard, cardCorner, showIndicatorLabel);
		}

		public Sentinel.Smoothers.SentinelSMA_v1_0_0 SentinelSMA_v1_0_0(ISeries<double> input, int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			if (cacheSentinelSMA_v1_0_0 != null)
				for (int idx = 0; idx < cacheSentinelSMA_v1_0_0.Length; idx++)
					if (cacheSentinelSMA_v1_0_0[idx] != null && cacheSentinelSMA_v1_0_0[idx].Period == period && cacheSentinelSMA_v1_0_0[idx].ShowCard == showCard && cacheSentinelSMA_v1_0_0[idx].CardCorner == cardCorner && cacheSentinelSMA_v1_0_0[idx].ShowIndicatorLabel == showIndicatorLabel && cacheSentinelSMA_v1_0_0[idx].EqualsInput(input))
						return cacheSentinelSMA_v1_0_0[idx];
			return CacheIndicator<Sentinel.Smoothers.SentinelSMA_v1_0_0>(new Sentinel.Smoothers.SentinelSMA_v1_0_0(){ Period = period, ShowCard = showCard, CardCorner = cardCorner, ShowIndicatorLabel = showIndicatorLabel }, input, ref cacheSentinelSMA_v1_0_0);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.Sentinel.Smoothers.SentinelSMA_v1_0_0 SentinelSMA_v1_0_0(int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return indicator.SentinelSMA_v1_0_0(Input, period, showCard, cardCorner, showIndicatorLabel);
		}

		public Indicators.Sentinel.Smoothers.SentinelSMA_v1_0_0 SentinelSMA_v1_0_0(ISeries<double> input , int period, bool showCard, SentinelCardCorner cardCorner, bool showIndicatorLabel)
		{
			return indicator.SentinelSMA_v1_0_0(input, period, showCard, cardCorner, showIndicatorLabel);
		}
	}
